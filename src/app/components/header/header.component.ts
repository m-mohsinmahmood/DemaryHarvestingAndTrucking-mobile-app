...
export class HeaderComponent implements OnInit {
  ...
  goBack() {
    ...
    else if (this.location.path() === '/tabs/home/harvesting/verify-ticket') {
      this.router.navigateByUrl('/tabs/home/harvesting');
    }
    else if (this.location.path() === '/tabs/home/harvesting') {
      this.router.navigateByUrl('/tabs/home');
    }
    else if (this.location.path().includes('training/trainer/road-skills/evaluation-form') || this.location.path().includes('training/trainer/basic-skills/digital-evaluation')) {
