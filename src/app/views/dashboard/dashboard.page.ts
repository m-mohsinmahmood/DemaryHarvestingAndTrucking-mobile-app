...
export class DashboardPage implements OnInit {
  ...
  initDataRetrieval() {
    ...
    this.dwrServices.getDWR(localStorage.getItem('employeeId')).subscribe(workOrder => {
      ...
      if (this.activeDwr.length <= 0) {
        ...
        // Original ID
        localStorage.setItem('employeeId', '4b843edb-0b74-49a2-b3c7-d3884f5f6012');
        // Testing ID
  ...
  onSelect(e) {
    ...
    else if (localStorage.getItem('role') === 'crew-chief') { localStorage.setItem('employeeId', '4b843edb-0b74-49a2-b3c7-d3884f5f6012'); }
